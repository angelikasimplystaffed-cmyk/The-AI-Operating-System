...
function doPost(e) {
  try {
    ...
    var htmlBody =
      ...
      '<p style="margin:0 0 14px;font-size:14px;line-height:1.75;color:#5a3860;">Your free playbook is attached to this email. Open it, save it, and keep it close &mdash; it is your step-by-step guide to implementing AI across your entire property business.</p>' +
      '<p style="margin:0 0 24px;font-size:14px;line-height:1.75;color:#5a3860;">The fastest way to get value: <strong>start with Section 2 &mdash; the 3 Things to Do This Week.</strong> You will save hours before Friday.</p>' +
      ...
      '<p style="margin:3px 0;font-size:13px;color:#38203e;">&#10022; &nbsp;The 4-Step Deployment Plan</p>' +
      '<p style="margin:3px 0;font-size:13px;color:#38203e;">&#10022; &nbsp;Best Tools &amp; Workflow Examples</p>' +
      '<p style="margin:3px 0;font-size:13px;color:#38203e;">&#10022; &nbsp;Your Property Business Intelligence Brief (PBIB)</p>' +
      '<p style="margin:3px 0;font-size:13px;color:#38203e;">&#10022; &nbsp;The RCCF Prompt Framework</p>' +
      '<p style="margin:3px 0;font-size:13px;color:#38203e;">&#10022; &nbsp;Your 30-Day Quick-Start Checklist</p>' +
      '</td></tr></table>' +
      ...
      '<p style="margin:0 0 6px;font-size:12px;color:#e4deec;">&copy; Simply Staffed AI &nbsp;&middot;&nbsp;<a href="' + WEBSITE_URL + '" style="color:#e8c153;text-decoration:none;">simplystaffed.com</a></p>' +
      '<p style="margin:0;font-size:11px;color:#a08aac;">You received this because you requested the free playbook. &nbsp;' +
      '<a href="mailto:' + UNSUBSCRIBE_EMAIL + '?subject=Unsubscribe&body=Please remove me from your list. My email: ' + email + '" style="color:#e8c153;text-decoration:underline;">Unsubscribe</a></p>' +
      '</td></tr>' +
