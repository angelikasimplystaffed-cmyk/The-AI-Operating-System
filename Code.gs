...
var PDF_DRIVE_ID      = '1XAT--XPBFX_qVS2mU3L9oQfipQLSzres';
  ...
  try {
    ...
    var htmlBody =
      ...
      '<p style="margin:0 0 14px;font-size:14px;line-height:1.75;color:#5a3860;">' +
        'Your free playbook is attached to this email. Open it, save it, and keep it close &mdash; it is your step-by-step guide to implementing AI across your entire property business.' +
      '</p>' +
      '<p style="margin:0 0 24px;font-size:14px;line-height:1.75;color:#5a3860;">' +
        'The fastest way to get value: <strong>start with Section 2 &mdash; the 3 Things to Do This Week.</strong> You will save hours before Friday.' +
      '</p>' +
      ...
      '<p style="margin:0 0 16px;font-size:13px;color:#8a6892;line-height:1.6;">' +
